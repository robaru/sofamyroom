function rirs = from_scenes_to_rirs(vast, rirs, params, sofamyroom_params)
    do_plot = false;
    ...
    for sample = 1:n_rirs
        ...
        dp_sofamyroom_params.options.reflectionorder = [ 0 0 0 ]; 
        rirs_dp = check_rirs(sofamyroom(dp_sofamyroom_params));
        % early reflection
        er_sofamyroom_params = sofamyroom_params;
        er_sofamyroom_params.options.reflectionorder = [ 1 1 1 ]; 
