...
switches = { '-DMEX'
             ...
             '-Isource\libfftw\Windows\Win32\include'
             '-Isource\libsfmt'
             '-Isource'
             '-Isource\libmysofa\Windows\Win32\include'
           };
options = { '-Lsource\libfftw\Windows\Win32\lib'
            '-lfftw3-3_32'
            '-Lsource\libmysofa\Windows\Win32\lib\Release'
            '-lmysofa.lib'
          };
output = 'roomsim';       
